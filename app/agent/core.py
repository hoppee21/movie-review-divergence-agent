...
class MovieEvidencePromptCore:
    ...
    def _render_prompt(
        ...
        lines = [
            ...
            "6. Use only compact refs from the evidence list; never invent refs and never output raw source_evidence_id values.",
            "7. Do not use outside knowledge.",
            "8. Avoid list markers such as '-', '*', or numbered outlines; the UI will handle visual structure.",
            "",
